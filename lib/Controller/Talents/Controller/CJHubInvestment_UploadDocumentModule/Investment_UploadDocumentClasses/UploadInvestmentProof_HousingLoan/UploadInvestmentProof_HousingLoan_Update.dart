...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: UploadInvestmentProof_HousingLoan_Update(title: 'CJ Hub'),
    );
  }
}
class UploadInvestmentProof_HousingLoan_Update extends StatefulWidget {

  UploadInvestmentProof_HousingLoan_Update({Key? key, this.title,this.homeLoanData}) : super(key: key);

  final String? title;
  final Data? homeLoanData;

  @override
  _UploadInvestmentProof_HousingLoan_Update createState() => _UploadInvestmentProof_HousingLoan_Update(homeLoanData!);
}

class _UploadInvestmentProof_HousingLoan_Update extends State<UploadInvestmentProof_HousingLoan_Update>
{
  Data? homeLoanData;
  ...
  String valueChoose_LoanType="Self" ;

  List listItem_LoanHolderType =["Personal","Other"];
  String? valueChoose_LoanHolderType="Self" ;
  ...
  String loanAmount="",propertyValue="",
      is_before_01_apr_1999="",is_first_time_buyer="";
  ...
  _UploadInvestmentProof_HousingLoan_Update(Data homeLoanData)
  {
    this.homeLoanData=homeLoanData;
  }
  ...
  loadData()
  {
    loan_no=homeLoanData!.loanNo;
    loan_sanction_date=homeLoanData!.loanSanctionDate;
    principal_amount = homeLoanData!.principalAmount;
    interest_amount = homeLoanData!.intrestAmount;
    name_of_owner = homeLoanData!.nameOfOwner;
    loan_type = homeLoanData!.loanType;
    loan_holder_type = homeLoanData!.loanHolderType;
    loan_holder_name = homeLoanData!.loanHolderName;
    lender_pan_number1 = homeLoanData!.lenderPanNumber1;
    lender_pan_number2 = homeLoanData!.lenderPanNumber2;
    lender_pan_number3 = homeLoanData!.lenderPanNumber3;
    lender_pan_number4 = homeLoanData!.lenderPanNumber4;

    lender_name = homeLoanData!.lenderName;

    valueChoose_LoanType=homeLoanData!.loanType;
    valueChoose_LoanHolderType=homeLoanData!.loanHolderType;

    document_path=homeLoanData!.documentPath;
    document_name=homeLoanData!.documentName;
    original_document_name=homeLoanData!.originalDocumentName;
    fileType_Name=original_document_name;

    loanAmount=homeLoanData!.loanAmount;
    propertyValue=homeLoanData!.propertyValue;
    is_before_01_apr_1999=homeLoanData!.isBefore01Apr1999;
    is_first_time_buyer=homeLoanData!.isFirstTimeBuyer;


/*------------24-1-2022 start----------------*/

    txtController_loan_no.text=loan_no;
    txtController_loanAmount.text=loanAmount;
    txtController_propertyValue.text=propertyValue;
    txtController_principal_amount.text=principal_amount;
    txtController_interest_amount.text=interest_amount;
    txtController_name_of_owner.text=name_of_owner;
    txtController_loan_holder_name.text=loan_holder_name;
    txtController_lender_name.text=lender_name;
    txtController_lender_pan_number1.text = lender_pan_number1;
    txtController_lender_pan_number2.text = lender_pan_number2;
    txtController_lender_pan_number3.text = lender_pan_number3;
    txtController_lender_pan_number4.text = lender_pan_number4;

/*------------24-1-2022 end----------------*/


    if(is_before_01_apr_1999=="Y")
    {
      Before01Apr1999=true;
    }
    else
    {
      Before01Apr1999=false;
    }

    if(is_first_time_buyer=="Y")
    {
      firstTimeBuyer=true;
    }
    else
    ...
    SharedPreference.networkImageToBase64(homeLoanData!.documentPath).then((value) =>  {
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (d != null)
      setState(()
      {
        ...
        loan_sanction_date = new DateFormat.yMd("en_US").format(d);
        loan_sanction_date=Method.changeTheDateFormat_ForUploadInvestmentDeclaration(loan_sanction_date);
      });
  }
      ...
      body:  SingleChildScrollView(
        ...
        Column(
          children: <Widget>[
            ...
            Container(
              // color: Colors.red,
              child: create_HousingLoan_ChooseFile(),
            ),
            ...
            Container(
              // color: Colors.red,
              child: create_HousingLoan_Button_Save(),
            ),
                        ...
                        child:  Checkbox(
                          ...
                          onChanged: (bool? value) {
                            setState(()
                            {
                              ...
                              //print('show the selected value $Before01Apr1999');
                            });
                          },
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Container(
                        width: MediaQuery
                            ...
                            .width * 0.4,
                        height: 30,
                        child: TextField(controller: txtController_loan_no,
                    ...
                    children: [
                      ...
                      Container(
                        width: MediaQuery
                            ...
                            .width * 0.4,
                        height: 30,
                        child: TextField(controller: txtController_loanAmount,
                      ...
                      Container(
                        ...
                        child:DropdownButton(
                          ...
                          onChanged: (newValue)
                          {
                            setState(()
                            {
                              valueChoose_LoanType = newValue as String;
                              loan_type!=newValue;
                            });
                          },
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child:DropdownButton(
                          ...
                          onChanged: (newValue){
                            setState(() {
                              valueChoose_LoanHolderType = newValue as String;
                              loan_holder_type!=newValue;
                            });
                          },
...
/*-----------------4-12-2021 end-------------------------*/
  ...
  Container create_HousingLoan_ChooseFile() {
    return Container(
        width: double.maxFinite,
        padding: const EdgeInsets.only(left: 10, right: 10),
  ...
  Container create_HousingLoan_Button_Save() {
    return Container(
        width: double.maxFinite,
        child: new Stack(
          children: <Widget>[
