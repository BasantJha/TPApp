...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: HrConnect_ClosedThread(title: 'CJ Hub'),
    );
  }
}

class HrConnect_ClosedThread extends StatefulWidget {
  HrConnect_ClosedThread({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _HrConnect_ClosedThread createState() => _HrConnect_ClosedThread();
}


class _HrConnect_ClosedThread extends State<HrConnect_ClosedThread>
{
  ...
  String empCode="";
  String completeEmpCode="",supportQueryId="";
  ...
  void initState()
  {
    ...
    if(kIsWeb){
      ...
      //print("This CJ Hub closed thread Web");
...
// This widget is the root of your application.
  ...
  /*---------COmmented show alert dialog ---------start-------*/
...
/*---------COmmented show alert dialog ---------end-------*/
