...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Profile_Document(title: 'CJ Hub'),
    );
  }
}
class Profile_Document extends StatefulWidget {

  Profile_Document({Key? key, this.title,this.profileData}) : super(key: key);

  final String? title;
  final Data? profileData;

  @override
  _Profile_Document createState() => _Profile_Document(profileData!);
}

// ignore: camel_case_types
class _Profile_Document extends State<Profile_Document> {
  ...
  _Profile_Document(Data profileDataType)
  {
    this.profileData=profileDataType!;
                  ...
                  children: [
                    ...
                    Container(
                      child:Align(
                        ...
                        child: Text(selectedItem,style: TextStyle(color: primaryColor,fontSize: 13),),
                      ),
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          // width: MediaQuery.of(context).size.width*0.31,   // Commented on 27-07-2022
...
/*  void _galleryPicker() async
  ...
  validateToTheFields()
  {
    ...
    {
      Method.snackBar_OkText(context, "Please choose the document");
      ...
      if (response.statusCode == 200)
      {
        ...
        else
        {
          if (profileDocumentSave_ModelResponse.message==null || profileDocumentSave_ModelResponse.message=="")
          {
            ...
            Method.snackBar_OkText(context, profileDocumentSave_ModelResponse.message!);
