...
class EmployerDetailsModelClass {
  List<CommonAddEmployeeWorkPlaceList>? commonAddEmployeeWorkPlaceList;

  EmployerDetailsModelClass({this.commonAddEmployeeWorkPlaceList});

  EmployerDetailsModelClass.fromJson(Map<String, dynamic> json) {
    if (json['commonAddEmployeeWorkPlaceList'] != null) {
      commonAddEmployeeWorkPlaceList = <CommonAddEmployeeWorkPlaceList>[];
      json['commonAddEmployeeWorkPlaceList'].forEach((v) {
        commonAddEmployeeWorkPlaceList!
            .add(new CommonAddEmployeeWorkPlaceList.fromJson(v));
      });
    }
  }
//
  Map<String, dynamic> toJson() {
    ...
    if (this.commonAddEmployeeWorkPlaceList != null) {
      data['commonAddEmployeeWorkPlaceList'] =
          this.commonAddEmployeeWorkPlaceList!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class CommonAddEmployeeWorkPlaceList {
  var empId;
  var empName;
  var postOffered;
  var dateofjoining;
  ...
  var suspendedinactivestatus;
  var exitsuspensiondate;
  var profileMinwagestate;
 /* var leavetemplateid;
  var leavetemplatetext;
*/
//
  CommonAddEmployeeWorkPlaceList(
      {this.empId,
        ...
        this.suspendedinactivestatus,
        this.exitsuspensiondate,
        this.profileMinwagestate,
        /*this.leavetemplateid, this.leavetemplatetext*/});

  CommonAddEmployeeWorkPlaceList.fromJson(Map<String, dynamic> json) {
    empId = json['emp_id'];
    ...
    suspendedinactivestatus = json['suspendedinactivestatus'];
    exitsuspensiondate = json['exitsuspensiondate'];
    profileMinwagestate = json['profile_minwagestate'];
    /*leavetemplateid = json['leavetemplateid'];
    leavetemplatetext = json['leavetemplatetext'];*/
  ...
  Map<String, dynamic> toJson() {
    ...
    data['suspendedinactivestatus'] = this.suspendedinactivestatus;
    data['exitsuspensiondate'] = this.exitsuspensiondate;
    data['profile_minwagestate'] = this.profileMinwagestate;
    /*data['leavetemplateid'] = this.leavetemplateid;
    data['leavetemplatetext'] = this.leavetemplatetext;*/
    return data;
  }
}