class EmployerTransactionModelClass {
  bool? statusCode;
  String? message;
  List<Data>? data;

  EmployerTransactionModelClass({this.statusCode, this.message, this.data});

  EmployerTransactionModelClass.fromJson(Map<String, dynamic> json) {
