class Employer_NewWorkPlaceLeaveSettingAttendanceModelClass {
  bool? statusCode;
  String? msg;
  List<Data>? data;

  Employer_NewWorkPlaceLeaveSettingAttendanceModelClass(
      {this.statusCode, this.msg, this.data});

  Employer_NewWorkPlaceLeaveSettingAttendanceModelClass.fromJson(
