...
class Employer_FlexibleCalculator extends StatefulWidget
{
  const Employer_FlexibleCalculator({Key? key, this.liveModelObj, this.selectedSalaryCalculatorType, this.mapObj, this.employeeAddObj}) : super(key: key);
  ...
  @override
  State<Employer_FlexibleCalculator> createState() => _Employer_FlexibleCalculator();
}

class _Employer_FlexibleCalculator extends State<Employer_FlexibleCalculator>
{
  ...
  TextEditingController salaryCal_Controller = TextEditingController();
        ...
        children: [
          ...
          Padding(
            ...
            child: TextField( inputFormatters: [
              ...
              controller: salaryCal_Controller,
                ...
                suffixIcon: suffixIconStatus==true?Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: ()
                    {
                      ...
                      flexibleSalary=salaryCal_Controller.text;
                      if(flexibleSalary=="" || flexibleSalary==null)
                        {
                  ...
                  onPressed: (){
                    ...
                    if(checkFlexibleCalculatorStatus==3)
                    {
                      ...
                      setState(() {
                        ...
                        salaryCal_Controller.text=salaryCalModelClass?.flexibleTime?.suggestivesalary;
                        resetPayoutStatus="";
                    ...
                    else if(checkFlexibleCalculatorStatus==4)
                    {
                      ...
                      setState(() {
                        suffixIconStatus==false;
                        salaryCal_Controller.text=salaryCalModelClass?.fullTime?.suggestivesalary;
                        resetPayoutStatus="";
                        hitApiRequestStatus=false;
...
//
    ...
    else
      {
        ...
        String uanNumber = data?.uannumber;
//
        if(uanNumber=="UAN IS OPTED" || uanNumber.length==12)
          {
  ...
  fullTimeCalculatorData(EmployerFlexibleCalculatorModelClass modelObj)
  {
    ...
    if(data?.calcresult=="Pass") {
      ...
      setState(() {
        ...
        print("show the full time basicSalaryList $basicSalaryList");
        String uanNumber = data?.uannumber;
        if (uanNumber == "" || uanNumber == null || uanNumber == "0") {
          uanNumber = "";
        }
...
/*------------------common api method for salary calculator start 29-1-2023------------------*/
  createBodyWebApi_CommonSalaryCalculatorApi()
  {
    ...
    if(salaryOffered=="")
    {
      ...
      {
        salaryOffered=salaryCal_Controller.text;
      }
//
    var mapObject=Map();
...
/*------------------common api method for salary calculator end 29-1-2023------------------*/
  ...
  createBodyWebApi_EmployerAddEmployee()
  {
    ...
    print("show the completed request ${widget.employeeAddObj!}");
