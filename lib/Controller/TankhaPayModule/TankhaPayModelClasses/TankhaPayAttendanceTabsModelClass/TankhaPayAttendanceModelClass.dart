...
class TankhaPayAttendanceModelClass {
  bool? statusCode;
  String? message;
  List<Data>? data;

  TankhaPayAttendanceModelClass({this.statusCode, this.message, this.data});

  TankhaPayAttendanceModelClass.fromJson(Map<String, dynamic> json) {
